function Footer(){
    return(
        <footer className="footer justify-center p-4 mt-10 inset-x-0 bottom-0 bg-base-200 lg:absolute">
            <div className="items-center grid-flow-col">
                ...
                <p>Copyright © 2023 - All right reserved - Made with <i className="fa-solid fa-heart text-red-600"></i> rdvid</p>
            </div> 
        </footer>
    )
}
